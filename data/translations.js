...
export const translations = {
  'pt-BR': {
    ...
    'tutorial_tip_4': '⏭️ Você pode pular tentativas se não souber',
    'tutorial_hints_system': 'Sistema de Dicas Progressivas',
    'tutorial_hints_desc': 'A cada tentativa errada, você recebe dicas específicas para te ajudar:',
    'tutorial_xp_system': 'Sistema de XP e Níveis',
    'tutorial_xp_desc': 'Ganhe experiência (XP) jogando e suba de nível para desbloquear conquistas:',
    'tutorial_achievements': 'Sistema de Conquistas',
    'tutorial_achievements_desc': 'Desbloqueie conquistas especiais jogando e explorando o jogo:',
    'tutorial_mode_differences': 'Diferenças entre os Modos',
    'tutorial_start_playing': 'Começar a Jogar',
    'tutorial_close': 'Fechar Tutorial',

    // Multiplayer Tutorial
    'multiplayer_tutorial_title': '👥 Como Jogar Multiplayer',
    'multiplayer_tutorial_subtitle': 'Guia completo para jogar com amigos',
    'multiplayer_creating_room': '🏠 Criando uma Sala',
    'multiplayer_joining_room': '🚪 Entrando em uma Sala',
    'multiplayer_scoring': '🏆 Sistema de Pontuação',
    'multiplayer_mechanics': '⚡ Mecânicas Especiais',
    'multiplayer_tips': '💡 Dicas para Multiplayer',
    'multiplayer_tutorial_close': 'Entendi, Vamos Jogar!',
  },
  'en-US': {
    // General texts
    'loading': 'Loading...',
    ...
    'tutorial_tip_4': '⏭️ You can skip attempts if you don\'t know',
    'tutorial_hints_system': 'Progressive Hints System',
    'tutorial_hints_desc': 'With each wrong attempt, you receive specific hints to help you:',
    'tutorial_xp_system': 'XP and Levels System',
    'tutorial_xp_desc': 'Gain experience (XP) by playing and level up to unlock achievements:',
    'tutorial_achievements': 'Achievements System',
    'tutorial_achievements_desc': 'Unlock special achievements by playing and exploring the game:',
    'tutorial_mode_differences': 'Differences Between Modes',
    'tutorial_start_playing': 'Start Playing',
    'tutorial_close': 'Close Tutorial',

    // Multiplayer Tutorial
    'multiplayer_tutorial_title': '👥 How to Play Multiplayer',
    'multiplayer_tutorial_subtitle': 'Complete guide to playing with friends',
    'multiplayer_creating_room': '🏠 Creating a Room',
    'multiplayer_joining_room': '🚪 Joining a Room',
    'multiplayer_scoring': '🏆 Scoring System',
    'multiplayer_mechanics': '⚡ Special Mechanics',
    'multiplayer_tips': '💡 Multiplayer Tips',
    'multiplayer_tutorial_close': 'Got it, Let\'s Play!',
  },
  'es': {
    // Textos generales
    'loading': 'Cargando...',
